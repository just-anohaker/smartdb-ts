...
export declare const ENTITY_VERSION_PROPERTY = "_version_";
export declare const ENTITY_EXTENSION_SYMBOL = "__extension__";
export declare type Versioned<T extends object> = Minix<T, {
    "_version_": number;
}>;
...
export declare type ModelAndKey = string;
export declare type ChangesHistoryItem<T extends object> = EntityChanges<T>;
export declare type TrackingEntityChangesItem<T extends object> = EntityChanges<T>;
export declare type TrackingEntity<T extends object> = Versioned<T>;
